...
const ACTIVITIES = [
  ...
  },
  {
    ...
    description:
      "Messieurs, chers Compagnons,\nNous avons reçu une invitation bien sympathique d'un groupe de Montois.",
  ...
  },
  {
    ...
    description:
      'Messieurs, chers Compagnons,\nCe 25 janvier 2026, à partir de 11h00, les acteurs vous invitent à un apéro.',
  ...
  },
  {
    ...
    description:
      'Messieurs,\nChers Compagnons,\nNous vous invitons à participer à la première Assemblée générale de la Compagnie.',
  ...
  {
    title: 'Frameries fête sa Patronne - Procession de Frameries',
    description:
      'La Compagnie Montoise des Hallebardiers est invitée à participer à la Procession de Frameries le 14 mai prochain.',
    datetime: new Date('2026-05-14T05:00:00.000Z'),
    points: 3,
    location: 'Foyer Sainte-Waudru - Mons',
    status: 'published',
    requiresAttendanceValidation: true,
  ...
  {
    title: 'Messe de Pâques à la gériatrie',
    description:
      'Le 28 mars prochain se déroulera la Messe de Pâques à la gériatrie.',
    datetime: new Date('2026-03-28T13:30:00.000Z'),
    points: 1,
    location: "Chemin de la Cure d'Air, Mons",
    status: 'published',
    requiresAttendanceValidation: true,
    requiresRegistration: true,
  },
